...
architecture rtl of kws_weights_hw_ram is 
...
architecture arch of kws_weights_hw is
    component kws_weights_hw_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    kws_weights_hw_ram_U :  component kws_weights_hw_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
