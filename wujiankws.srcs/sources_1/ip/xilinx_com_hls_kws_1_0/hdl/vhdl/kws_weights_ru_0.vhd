...
entity kws_weights_ru_0_ram is 
    generic(
...
architecture rtl of kws_weights_ru_0_ram is 
...
architecture arch of kws_weights_ru_0 is
    component kws_weights_ru_0_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    kws_weights_ru_0_ram_U :  component kws_weights_ru_0_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
