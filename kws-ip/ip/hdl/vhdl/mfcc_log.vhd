...
architecture behav of mfcc_log is 
    ...
    signal tmp_s_reg_408 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_73_fu_202_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_74_fu_214_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln131_2_fu_222_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal zext_ln131_fu_210_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_41_fu_248_p4 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_277_fu_296_p4 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component kws_dlog_64ns_64nDeQ IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    kws_fptrunc_64ns_Aem_U96 : component kws_fptrunc_64ns_Aem
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    kws_fpext_32ns_64Bew_U97 : component kws_fpext_32ns_64Bew
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    kws_dcmp_64ns_64nCeG_U98 : component kws_dcmp_64ns_64nCeG
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    kws_dlog_64ns_64nDeQ_U99 : component kws_dlog_64ns_64nDeQ
    generic map (
        ID => 1,
        NUM_STAGE => 31,
        din0_WIDTH => 64,
    ...
    kws_mux_416_32_1_1_U100 : component kws_mux_416_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    icmp_ln132_fu_310_p2 <= "0" when (tmp_277_fu_296_p4 = ap_const_lv11_7FF) else "1";
    ...
    select_ln134_fu_334_p3 <= 
        ...
        tmp_reg_396;
    tmp_277_fu_296_p4 <= bitcast_ln132_fu_293_p1(62 downto 52);
    tmp_41_fu_248_p4 <= j_0_reg_159(5 downto 2);
    tmp_73_fu_202_p3 <= (i_0_reg_148 & ap_const_lv3_0);
    tmp_74_fu_214_p3 <= (i_0_reg_148 & ap_const_lv1_0);
    ...
    zext_ln131_2_fu_222_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_74_fu_214_p3),10));
    zext_ln131_3_fu_258_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_41_fu_248_p4),10));
    zext_ln131_4_fu_267_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln131_1_fu_262_p2),64));
    zext_ln131_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_73_fu_202_p3),10));
end behav;
