...
wire   [23:0] tmp_96_fu_552_p3;
reg   [23:0] tmp_96_reg_932;
...
wire   [8:0] tmp_109_fu_480_p3;
wire   [10:0] tmp_108_fu_473_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp2_stage0) & (icmp_ln49_1_reg_873_pp2_iter7_reg == 1'd1) & (1'b0 == ap_block_pp2_stage0_11001))) begin
        ...
        tmp_96_reg_932[22 : 0] <= tmp_96_fu_552_p3[22 : 0];
    end
end
...
assign lshr_ln286_fu_616_p2 = tmp_96_fu_552_p3 >> sext_ln281_fu_572_p1;
...
assign select_ln282_fu_634_p3 = ((and_ln282_fu_628_p2[0:0] === 1'b1) ? tmp_96_fu_552_p3 : 24'd0);
...
assign select_ln288_fu_705_p3 = ((tmp_128_fu_698_p3[0:0] === 1'b1) ? 32'd4294967295 : 32'd0);
...
assign sub_ln215_fu_491_p2 = (tmp_108_fu_473_p3 - zext_ln215_fu_487_p1);

assign sub_ln461_fu_754_p2 = (32'd0 - select_ln285_11_fu_746_p3);

assign tmp_108_fu_473_p3 = {{select_ln51_reg_845}, {4'd0}};

assign tmp_109_fu_480_p3 = {{select_ln51_reg_845}, {2'd0}};

assign tmp_128_fu_698_p3 = reg_V_reg_922[32'd31];

assign tmp_96_fu_552_p3 = {{1'd1}, {trunc_ln270_fu_548_p1}};
...
assign zext_ln215_fu_487_p1 = tmp_109_fu_480_p3;

assign zext_ln283_fu_692_p1 = tmp_96_reg_932;
