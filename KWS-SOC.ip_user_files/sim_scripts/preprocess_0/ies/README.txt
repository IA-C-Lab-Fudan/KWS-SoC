...
#
# Generated by export_simulation on Wed Jul 01 22:45:36 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './preprocess_0.sh' script.

./preprocess_0.sh -reset_run
...
./preprocess_0.sh -noclean_files

For more information on the script, please type './preprocess_0.sh -help'.
