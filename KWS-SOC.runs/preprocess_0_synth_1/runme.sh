...
HD_PWD='D:/wulian/KWS-SOC/KWS-SOC.runs/preprocess_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log preprocess_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source preprocess_0.tcl
